...
$reponse = $bdd->query('SELECT * FROM Romantique INNER JOIN Utilisateur ON Utilisateur_idUtilisateur=idUtilisateur ORDER BY Date_Roman DESC');
...
<center><table cellspacing="0" cellpadding="0" border="0" width="680">
		...
		<td>
			<table cellspacing="0" cellpadding="0" border="1" width="674">
				<tr>
					...
					<td align=center><?php echo $donnees['Nom_Roman']; ?></td>
					<td align=center><?php echo $donnees['Date_Roman']; ?></td>
		...
		<td>
			...
			<table cellspacing="0" cellpadding="1" border="1" width="674">
				<tr>
					<td colspan=3 align=center style="overflow:auto"><?php echo $donnees['Texte_Roman']; ?></td>
				<tr>
			</table>
			</div>
		</td>
